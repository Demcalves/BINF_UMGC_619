...
- With regards to data storage and clean up operations, for this project the data generated (excluding temporary files) were kept
  ...
  were generated. The files are loosely generated and would be best stored in a folder for that job. The current iteration of this project is
  however in a stable setting for release. 
